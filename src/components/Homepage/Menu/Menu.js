  ...
  return (
    <section id="menu" className="min-h-screen pt-20 pb-6 px-[7%]">
      ...
      <div className="menu-section flex flex-wrap justify-center gap-5 mt-10">
        <FadeIn delay={400}>
          <div className="group relative flex flex-col w-64 h-96 text-muted justify-end shadow items-center rounded-md overflow-hidden space-y-2">
            <img
            ...
            />
            <h3 className="text-center md:-translate-y-30 group-hover:translate-y-0 transition duration-300">
              Coffee
            </h3>
            <a
              href="/menu/coffee"
              target="_blank"
              className="cursor-pointer text-sm active:underline md:translate-y-10 group-hover:translate-y-0 transition duration-300 mb-2 hover:underline"
            >
              Lihat Semua
            </a>
          </div>
