  ...
  return (
    <section id="contact" className="min-h-screen pt-20 pb-6 px-[7%]">
      ...
      <p className="max-w-[30rem] text-center text-sm font-thin mx-auto mt-4 leading-6">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas unde optio
        fugiat alias deleniti sapiente!
      </p>

      <div className="flex flex-wrap mt-8 bg-[#222] inset-shadow inset-shadow-red-400 shadow-white/50 gap-5">
        <iframe
          ...
          className="flex-[1_1_20rem] h-64 sm:h-auto"
        ></iframe>

        <form
          onSubmit={form.onSubmit((values) => handleSubmit(values))}
          className="flex-[1_1_15rem] text-center pl-2 pr-5 py-8"
        >
          <TextInput
            type="text"
            placeholder="Nama"
